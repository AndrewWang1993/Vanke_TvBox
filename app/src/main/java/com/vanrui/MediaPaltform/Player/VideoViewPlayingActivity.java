...
public class VideoViewPlayingActivity extends Activity implements OnPreparedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean mIsHwDecode = getIntent().getBooleanExtra("isHW", false);
     ...
     */
    private void initUI() {
        RelativeLayout mViewHolder = (RelativeLayout) findViewById(R.id.view_holder);
        LinearLayout mControllerHolder = (LinearLayout) findViewById(R.id.controller_holder);
        ...
        BMediaController mVVCtl = new BMediaController(this);
